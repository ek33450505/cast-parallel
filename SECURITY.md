...
|---------|---------------|
| 0.1.0 (current) | Full support — security and bug fixes |

## Reporting a Vulnerability

**Do not open a public GitHub Issue for security vulnerabilities.**

Report security issues privately via [GitHub Security Advisories](https://github.com/ek33450505/cast-parallel/security/advisories/new).
This keeps the details confidential until a fix is released.

### What to include

- cast-parallel version
...
- Vulnerabilities in third-party tools (git, Claude Code CLI, etc.) — report to those projects directly
